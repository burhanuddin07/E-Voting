...
public class AdminResult extends AppCompatActivity {
    ...
    private void displayChart(float v1,float v2,float v3,float v4) {
        ...
        pieChartData.setHasCenterCircle(true).setCenterText1("Total Votes").setCenterText1FontSize(20).setCenterText1Color(Color.WHITE);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        finish();
        startActivity(new Intent(AdminResult.this,AdminSide.class));
    }
}
