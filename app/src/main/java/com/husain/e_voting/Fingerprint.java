...
public class Fingerprint extends AppCompatActivity {
    ...
    private static final String KEY_NAME = "husain";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!fingerprintManager.isHardwareDetected())
            ...
            if (!fingerprintManager.hasEnrolledFingerprints())
                Toast.makeText(this, "Atleast enroll one fingerprint in settings", Toast.LENGTH_SHORT).show();
            else {
                if (!keyguardManager.isKeyguardSecure())
                    Toast.makeText(this, "Lock screen security noe enabled in settings", Toast.LENGTH_SHORT).show();
                else
                    genKey();
